...
<form action="/dashboard/librarians/{{ $user->id }}" method="POST">
  @csrf
  @method('put')
  <div class="text-2xl font-bold mb-4">Edit Pustakawan</div>
  <div class="grid gap-6 mb-6 md:grid-cols-1">
      ...
      <div class="">
        <a href="/dashboard/librarians/changepassword/{{ $user->id }}" class="bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 px-3 py-1.5 rounded-full">Ganti Password</a>
      </div>
  </div>
