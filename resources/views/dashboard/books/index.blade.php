...
<div class="w-full flex justify-start items-center py-2">
    <a href="/dashboard/books/create" class="inline-flex items-center text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">+ Tambah Buku</a>
</div>
<table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
    ...
    <tbody>
        ...
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            ...
            <td class="px-6 py-4">
                <img src="{{ asset('/storage/'.$book->image) }}" alt="" class="object-cover w-20 aspect-[6/9]">
            </td>
            <td class="px-6 py-4">
                {{ $book->stock_init }}
            </td>
            ...
            <td class="px-6 py-4 gap-2">
                <a href="/dashboard/books/{{ $book->slug }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Detail</a>
